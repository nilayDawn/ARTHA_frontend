    ...
    <div className="min-h-screen bg-[#050505] text-[#F2F2F2] font-sans antialiased selection:bg-[#00D9A5]/30 selection:text-[#00D9A5]">
      ...
      <section className="relative pt-16 pb-24 md:pt-24 md:pb-32 overflow-hidden border-b border-[rgba(255,255,255,0.08)]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          {/* Main Title */}
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-[#F2F2F2] max-w-4xl mx-auto leading-[1.15]">
            Master your wealth with <span className="text-[#D6A84F]">purpose</span> & intelligence.
          </h1>

          {/* Subtitle */}
          <p className="mt-6 text-base sm:text-lg text-[#8A8F8D] max-w-2xl mx-auto font-normal leading-relaxed">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              to="/login"
              className="w-full sm:w-auto px-6 py-3.5 bg-[#0B0F0E] hover:bg-[#121917] text-[#F2F2F2] border border-[rgba(255,255,255,0.08)] font-semibold text-sm rounded-xl transition-colors flex items-center justify-center gap-2 cursor-pointer"
            >
          ...
          <div className="mt-14 max-w-5xl mx-auto rounded-2xl bg-[#0B0F0E] border border-[rgba(255,255,255,0.08)] shadow-2xl p-4 sm:p-6 text-left overflow-hidden relative">
            ...
            <div className="flex items-center justify-between pb-4 border-b border-[rgba(255,255,255,0.08)] mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-[#8A8F8D] ml-2 font-mono">artha-cfo-v1.0.4.live</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 rounded-xl bg-[#050505] border border-[rgba(255,255,255,0.08)]">
                <span className="text-[11px] text-[#8A8F8D] uppercase tracking-wider block mb-1">Total Assets</span>
                <div className="text-2xl font-extrabold text-[#F2F2F2]">₹128,450.00</div>
              ...
              {/* Stat Card 2 */}
              <div className="p-4 rounded-xl bg-[#050505] border border-[rgba(255,255,255,0.08)]">
                <span className="text-[11px] text-[#8A8F8D] uppercase tracking-wider block mb-1">Monthly Surplus</span>
                <div className="text-2xl font-extrabold text-[#D6A84F]">₹2,410.50</div>
                <div className="mt-2 text-xs text-[#8A8F8D]">Allocated to savings & investment</div>
              </div>

              {/* Stat Card 3 */}
              <div className="p-4 rounded-xl bg-[#050505] border border-[rgba(255,255,255,0.08)]">
                <span className="text-[11px] text-[#8A8F8D] uppercase tracking-wider block mb-1">Goal Status</span>
                <div className="text-2xl font-extrabold text-[#F2F2F2]">84% Complete</div>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-semibold transition-all cursor-pointer border ₹{
                  activePromptIndex === idx
                    ...
                    : 'bg-[#050505] text-[#8A8F8D] border-[rgba(255,255,255,0.08)] hover:text-[#F2F2F2]'
                }`}
              >
                {item.tag}
              </button>
